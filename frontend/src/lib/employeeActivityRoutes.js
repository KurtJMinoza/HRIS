...
const ROUTE_ACTIVITY = [
  ...
  { prefix: '/admin/my-dashboard', module: 'My Workspace', title: 'My Dashboard' },
  { prefix: '/admin/my-schedule', module: 'My Workspace', title: 'My Schedule' },
  { prefix: '/admin/my-leave', module: 'My Workspace', title: 'My Leave' },
  { prefix: '/admin/my-overtime', module: 'My Workspace', title: 'My Overtime' },
  { prefix: '/admin/my-attendance', module: 'My Workspace', title: 'My Attendance' },
  { prefix: '/admin/my-corrections', module: 'My Workspace', title: 'My Corrections' },
  { prefix: '/admin/my-holidays', module: 'My Workspace', title: 'My Holidays' },
