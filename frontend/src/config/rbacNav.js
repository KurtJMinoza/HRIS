...
const pathToPermissions = {
  ...
  '/admin/compensation/generate-payslips': ['payslip.generate', 'consultant.payroll.generate', 'execom.payroll.generate'],
  ...
  '/admin/consultant/payroll/finalize': ['consultant.payroll.generate', 'consultant.payroll.finalize', 'consultant.view', 'payslip.generate', 'payslip.finalize'],
