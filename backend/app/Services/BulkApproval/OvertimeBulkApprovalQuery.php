...
class OvertimeBulkApprovalQuery implements ApprovableBulkQuery
{
    ...
    public function baseQuery(User $actor, array $filters): Builder
    {
        ...
        if ($scopedEmployeeIds !== null) {
            ...
            // Match OvertimeController visibility: assigned/handled approvals.
                ...
                $query->where(function ($scope) use ($actorId): void {
                    $scope->whereExists(function ($approval) use ($actorId): void {
                        $approval
                            ...
                            ->whereColumn('current_approval.request_id', 'overtimes.id')
                        ...
                        $approval
                            ...
                            ->whereColumn('handled_approval.request_id', 'overtimes.id')
                            ->where('handled_approval.module_type', OrgApprovalWorkflowService::MODULE_OVERTIME)
