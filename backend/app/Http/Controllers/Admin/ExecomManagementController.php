...
class ExecomManagementController extends Controller
{
    ...
    private function profilePayload(?ExecomEmployeeProfile $profile): ?array
    {
        ...
        return [
            ...
            'profile_image' => $profile->employee?->profile_image_url,
            'profile_image_url' => $profile->employee?->profile_image_url,
            'profile_picture_url' => $profile->employee?->profile_image_url,
            'avatar_url' => $profile->employee?->profile_image_url,
            'company_id' => $profile->company_id ? (int) $profile->company_id : null,
