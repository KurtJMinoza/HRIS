...
/**
 * Org heads use `/company|branch|department/loans-deductions` (not `/employee/*`); they need the same
 * self-service loan permissions as employees for {@see \App\Http\Controllers\EmployeeLoanRequestController}.
 */
return new class extends Migration
{
    public function up(): void
    {
        $slugs = ['loans.view_own', 'loans.request'];
