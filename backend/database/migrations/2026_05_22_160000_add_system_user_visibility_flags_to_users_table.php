    ...
    public function up(): void
    {
        Schema::table('users', function (Blueprint $table): void {
            ...
            if (! Schema::hasColumn('users', 'exclude_from_approvals')) {
                $table->boolean('exclude_from_approvals')->default(false)->after('exclude_from_attendance')->index();
            }
        });

        if (Schema::hasTable('user_admin_activity_logs')) {
            Schema::table('user_admin_activity_logs', function (Blueprint $table): void {
                if (! Schema::hasColumn('user_admin_activity_logs', 'actor_role')) {
