...
return [
    'permissions' => [
        ...
        ['slug' => 'attendance.manual.view', 'module' => 'attendance', 'label' => 'View manual attendance', 'description' => 'View admin manual attendance records'],
        ['slug' => 'attendance.manual.create', 'module' => 'attendance', 'label' => 'Create manual attendance', 'description' => 'Directly create approved manual attendance records'],
        ['slug' => 'attendance.manual.edit', 'module' => 'attendance', 'label' => 'Edit manual attendance', 'description' => 'Edit approved manual attendance records'],
        ['slug' => 'attendance.manual.reverse', 'module' => 'attendance', 'label' => 'Reverse manual attendance', 'description' => 'Reverse manual attendance records'],
        ['slug' => 'attendance.manual.bulk_create', 'module' => 'attendance', 'label' => 'Bulk manual attendance', 'description' => 'Create manual attendance for multiple employees'],
        ['slug' => 'attendance.manual.override_conflict', 'module' => 'attendance', 'label' => 'Override manual attendance conflicts', 'description' => 'Override leave or attendance conflicts when creating manual attendance'],
