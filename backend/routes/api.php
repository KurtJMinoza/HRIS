...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::middleware(['hr.panel'])->group(function () {
        ...
        Route::middleware('permission:dashboard.view')->group(function () {
            ...
            Route::get('/admin/dashboard/company-efficiency', [DashboardController::class, 'companyEfficiency']);
            Route::get('/admin/dashboard/company-efficiency/{companyId}/attendance', [DashboardController::class, 'companyEfficiencyAttendance'])->whereNumber('companyId');
            Route::get('/admin/dashboard/company-efficiency-details/{companyId}', [DashboardController::class, 'companyEfficiencyDetails']);
        });
        ...
        Route::middleware('permission:geofence.update|geofence.enable_disable')->put('/admin/geofencing/module-settings', [GeofenceController::class, 'updateModuleSettings']);
        Route::middleware('permission:geofence.update|geofence.enable_disable')->put('/admin/geofencing/employee-exemptions', [GeofenceController::class, 'updateEmployeeExemptions']);
        Route::middleware('permission:geofence.update|geofence.enable_disable')->patch('/admin/employees/{employeeId}/geofence-enforcement', [GeofenceController::class, 'updateEmployeeGeofenceEnforcement'])->whereNumber('employeeId');
        ...
        Route::middleware('permission:attendance.corrections.approve')->group(function () {
            ...
            Route::post('/attendance-corrections/bulk-preview', [PresenceFilingController::class, 'bulkApprovePreview']);
            ...
            Route::get('/attendance-corrections/bulk-progress/{bulkToken}', [PresenceFilingController::class, 'bulkProgress']);
        ...
        Route::middleware('permission:employees.view')->group(function () {
            ...
            Route::get('/admin/employees/check-employee-code', [EmployeeController::class, 'checkEmployeeCode']);
        ...
        Route::middleware('permission:leave.approve')->group(function () {
            ...
            Route::post('/leave-requests/bulk-preview', [LeaveController::class, 'bulkApprovePreview']);
            ...
            Route::get('/leave-requests/bulk-progress/{bulkToken}', [LeaveController::class, 'bulkProgress']);
        ...
        Route::middleware('permission:overtime.approve')->post('/overtime-requests/bulk-preview', [OvertimeController::class, 'bulkApprovePreview']);
        ...
        Route::middleware('permission:overtime.approve')->get('/overtime-requests/bulk-progress/{bulkToken}', [OvertimeController::class, 'bulkProgress']);
