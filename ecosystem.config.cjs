...
// Match backend/.env FACE_VERIFICATION_URLS (5000-5003). Override with FACE_SERVICE_PORTS.
const faceServicePorts = (process.env.FACE_SERVICE_PORTS || '5000,5001,5002,5003')
  .split(',')
  .map((p) => p.trim())
  .filter(Boolean);
